 ...
 * @author Shinn Lok
 */
public class SiteGroupThreadLocal {
	...
	private static Log _log = LogFactoryUtil.getLog(SiteGroupThreadLocal.class);

	private static ThreadLocal<Boolean> _deleteInProcess =
		new AutoResetThreadLocal<Boolean>(
			SiteGroupThreadLocal.class + "._deleteInProcess", false);
	private static ThreadLocal<Long> _groupId =
		new AutoResetThreadLocal<Long>(
			SiteGroupThreadLocal.class + "._groupId",
