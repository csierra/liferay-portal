...
<liferay-ui:icon-menu icon="<%= StringPool.BLANK %>" message="<%= StringPool.BLANK %>">
	...
	<c:if test="<%= PollsQuestionPermissionUtil.contains(permissionChecker, question, ActionKeys.PERMISSIONS) %>">
	...
	<c:if test="<%= PollsQuestionPermissionUtil.contains(permissionChecker, question, ActionKeys.DELETE) %>">
