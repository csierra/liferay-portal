...
public class Compose<T, AP1, AP2>
	...
	@Override
	public <S> Applicative<Compose<?, AP1, AP2>, S> map(Function1<T, S> fun) {
		Applicative<AP1, S> fmap1 = (Applicative<AP1, S>)_ap1.map(fun);
		Applicative<AP2, S> fmap2 = (Applicative<AP2, S>)_ap2.map(fun);
