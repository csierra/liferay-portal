...
public class PasswordMetaUtil {
	 ...
	 * @return the matching password metas
	 */
	public static List<PasswordMeta> findByPasswordHashProviderId(
		long passwordHashProviderId) {

		return getPersistence().findByPasswordHashProviderId(
	...
	public static List<PasswordMeta> findByPasswordHashProviderId(
		...
		return getPersistence().findByPasswordHashProviderId(
			passwordHashProviderId, start, end);
	}
	 ...
	 * @throws NoSuchMetaException if a matching password meta could not be found
	 */
	public static PasswordMeta findByPasswordHashProviderId_First(
			long passwordHashProviderId,
			OrderByComparator<PasswordMeta> orderByComparator)
		throws com.liferay.portal.security.password.exception.
			NoSuchMetaException {

		return getPersistence().findByPasswordHashProviderId_First(
	 ...
	 * @return the first matching password meta, or <code>null</code> if a matching password meta could not be found
	 */
	public static PasswordMeta fetchByPasswordHashProviderId_First(
		long passwordHashProviderId,
		OrderByComparator<PasswordMeta> orderByComparator) {

		return getPersistence().fetchByPasswordHashProviderId_First(
			passwordHashProviderId, orderByComparator);
	}
	 ...
	 * @throws NoSuchMetaException if a matching password meta could not be found
	 */
	public static PasswordMeta findByPasswordHashProviderId_Last(
			long passwordHashProviderId,
			OrderByComparator<PasswordMeta> orderByComparator)
		throws com.liferay.portal.security.password.exception.
			NoSuchMetaException {

		return getPersistence().findByPasswordHashProviderId_Last(
			passwordHashProviderId, orderByComparator);
	}
	 ...
	 * @return the last matching password meta, or <code>null</code> if a matching password meta could not be found
	 */
	public static PasswordMeta fetchByPasswordHashProviderId_Last(
		long passwordHashProviderId,
		OrderByComparator<PasswordMeta> orderByComparator) {

		return getPersistence().fetchByPasswordHashProviderId_Last(
			passwordHashProviderId, orderByComparator);
	}
	 ...
	 * @throws NoSuchMetaException if a password meta with the primary key could not be found
	 */
	public static PasswordMeta[] findByPasswordHashProviderId_PrevAndNext(
			long passwordMetaId, long passwordHashProviderId,
			OrderByComparator<PasswordMeta> orderByComparator)
		throws com.liferay.portal.security.password.exception.
			NoSuchMetaException {

		return getPersistence().findByPasswordHashProviderId_PrevAndNext(
			passwordMetaId, passwordHashProviderId, orderByComparator);
	}
	 ...
	 * @param passwordHashProviderId the password hash provider ID
	 */
	public static void removeByPasswordHashProviderId(
		long passwordHashProviderId) {

		getPersistence().removeByPasswordHashProviderId(passwordHashProviderId);
	}
	 ...
	 * @return the number of matching password metas
	 */
	public static int countByPasswordHashProviderId(
		long passwordHashProviderId) {

		return getPersistence().countByPasswordHashProviderId(
			passwordHashProviderId);
	}
