...
public class PasswordHashProviderLocalServiceUtil {
	...
	public static
		com.liferay.portal.security.password.model.PasswordHashProvider
				addPasswordHashProvider(String name, org.json.JSONObject meta)
			throws com.liferay.portal.kernel.exception.PortalException {

		return getService().addPasswordHashProvider(name, meta);
	}

	public static
		com.liferay.portal.security.password.model.PasswordHashProvider
				addPasswordHashProvider(String name, String metaJSON)
			throws com.liferay.portal.kernel.exception.PortalException {

		return getService().addPasswordHashProvider(name, metaJSON);
	}
	...
	public static
		com.liferay.portal.security.password.model.PasswordHashProvider
			fetchPasswordHashProvider(String name, org.json.JSONObject meta) {

		return getService().fetchPasswordHashProvider(name, meta);
	}
