...
package com.liferay.portal.remote.jaxrs.util.optional;
...
public class OptionalBodyWriter implements MessageBodyWriter<Optional<?>> {
	...
	public static Response createEmptyResponse(String resourceName) {
		ResourceMissingEntity resourceMissingEntity = new ResourceMissingEntity(
			"Not found", resourceName, "");

		Response.ResponseBuilder status = Response.status(422);

		Response.ResponseBuilder entity = status.entity(resourceMissingEntity);
	...
	public void writeTo(
		...
		MessageBodyWriter<Object> realMessageBodyWriter =
			(MessageBodyWriter<Object>)providers.getMessageBodyWriter(
				targetClass, targetClass, annotations, mediaType);
