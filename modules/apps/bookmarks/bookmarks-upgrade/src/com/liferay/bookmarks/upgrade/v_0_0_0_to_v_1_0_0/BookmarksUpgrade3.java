...
@Component(
	immediate = true,
	property = {
		UpgradeConstants.FROM + "=1.1.0",
		UpgradeConstants.TO + "=1.2.0",
		UpgradeConstants.APPLICATION_NAME + "=bookmarks"
	},
	service = UpgradeProcess.class)
public class BookmarksUpgrade3 extends UpgradeProcess {
	...
	protected void doUpgrade() throws PortalException {
		System.out.println("Upgrade from 1.1.0 to 1.2.0");
	}
