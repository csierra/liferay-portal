...
public class CORSConfigurationTest extends BaseCORSClientTestCase {
	...
	public void testDuplicateConfiguration() throws Exception {
		_createFactoryConfiguration(
			_companyId, _PATTERNS_DUPLICATE, "http://www.liferay.com");

		try {
			_createFactoryConfiguration(
				_companyId, _PATTERNS_DUPLICATE, "http://www.google.com");
		}
	...
	public void testNonoverwrittenConfiguration() throws Exception {
		_createFactoryConfiguration(
			0, _PATTERNS_SYSTEM_ONLY, "http://www.liferay.com");

		_createFactoryConfiguration(
			_companyId, _PATTERNS_INSTANCE_ONLY, "http://www.google.com");
	...
	public void testOverwrittenConfiguration() throws Exception {
		_createFactoryConfiguration(
			0, _PATTERNS_OVERWRITTEN, "http://www.google.com");

		_createFactoryConfiguration(
			_companyId, _PATTERNS_OVERWRITTEN, "http://www.liferay.com");
	...
	private static final String[] _PATTERNS_DUPLICATE = {
		"/o/cors-app/duplicate/path/*"
	};

	private static final String[] _PATTERNS_INSTANCE_ONLY = {
		"/o/cors-app/instance/only/path/*"
	};

	private static final String[] _PATTERNS_OVERWRITTEN = {
		"/o/cors-app/overwritten/path/*"
	};

	private static final String[] _PATTERNS_SYSTEM_ONLY = {
