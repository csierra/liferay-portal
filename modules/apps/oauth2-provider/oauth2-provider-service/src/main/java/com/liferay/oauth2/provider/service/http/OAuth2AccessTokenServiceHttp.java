...
import com.liferay.oauth2.provider.service.OAuth2AccessTokenServiceUtil;
 ...
 * {@link OAuth2AccessTokenServiceUtil} service utility. The
 ...
 * @see OAuth2AccessTokenServiceSoap
 * @see HttpPrincipal
...
public class OAuth2AccessTokenServiceHttp {
	public static com.liferay.oauth2.provider.model.OAuth2AccessToken deleteOAuth2AccessToken(
		...
		try {
			...
			return (com.liferay.oauth2.provider.model.OAuth2AccessToken)returnObj;
		}
