...
@Meta.OCD(
	id = "com.liferay.oauth2.configuration.OAuth2Configuration",
...
public interface OAuth2Configuration {
	...
	@Meta.AD(
		...
		name = "oauth2-allow-authorization-code-grant",
		required = false)
	...
	@Meta.AD(
		...
		name = "oauth2-allow-client-credentials-grant",
		required = false)
	...
	@Meta.AD(
		...
		name = "oauth2-allow-refresh-token-grant",
		required = false)
