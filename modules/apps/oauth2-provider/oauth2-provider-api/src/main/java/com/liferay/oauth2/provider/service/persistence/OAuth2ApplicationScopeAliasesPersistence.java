...
public interface OAuth2ApplicationScopeAliasesPersistence
	...
	*/
	public java.util.List<OAuth2ApplicationScopeAliases> findByC(long companyId);
	...
	*/
	public java.util.List<OAuth2ApplicationScopeAliases> findByC(
		long companyId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<OAuth2ApplicationScopeAliases> orderByComparator);
	...
	* @return the matching o auth2 application scope aliaseses
	*/
	public java.util.List<OAuth2ApplicationScopeAliases> findByOAuth2ApplicationId(
	...
	*/
	public void cacheResult(
		java.util.List<OAuth2ApplicationScopeAliases> oAuth2ApplicationScopeAliaseses);
	...
	*/
	public java.util.List<OAuth2ApplicationScopeAliases> findAll(int start,
		int end);
