 ...
 * must only be executed if the incoming request is authorized for the scope
...
public @interface RequiresScope {
	...
	/**
	 * @return whether the returned scope in {@link RequiresScope#value()}
	 * all need to be authorized or only one of them. Defaults to
	 * <code>true</code>, which means all the specified scope need to be
	 * authorized.
	 * @review
	 */
	...
	/**
	 * @return The list of scope that the request needs to be authorized for
