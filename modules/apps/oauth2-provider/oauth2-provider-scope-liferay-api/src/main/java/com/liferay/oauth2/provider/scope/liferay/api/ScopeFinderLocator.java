...
public interface ScopeFinderLocator {
	 ...
	 * scope with the configuration for that company.
	 * @param company the company for which the scope are to be located
	 * @param scope the requested scope
	 * @return a collection of matching scope for the given company and
	 * scope name
	 */
	...
	/*Map<String, Set<String>> describeScopes(
		long companyId, Locale locale, String ... scope);*/
