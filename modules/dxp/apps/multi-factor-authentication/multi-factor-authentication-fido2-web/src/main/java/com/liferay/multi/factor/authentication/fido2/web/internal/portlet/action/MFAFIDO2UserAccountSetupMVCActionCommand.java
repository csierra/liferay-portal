...
import com.liferay.multi.factor.authentication.fido2.web.internal.checker.FIDO2BrowserSetupMFAChecker;
...
public class MFAFIDO2UserAccountSetupMVCActionCommand
	...
	protected void doProcessAction(
		...
		FIDO2BrowserSetupMFAChecker fido2BrowserSetupMFAChecker = null;

		try {
			fido2BrowserSetupMFAChecker =
				(FIDO2BrowserSetupMFAChecker)setupMFAChecker;
		}
		catch (ClassCastException classCastException) {
			_log.error(classCastException.getMessage());

			return;
		}

		long authenticatorId = ParamUtil.getLong(
			actionRequest, "authenticatorId");

		if (authenticatorId != 0) {
			fido2BrowserSetupMFAChecker.removeCredentialEntry(authenticatorId);
		}
