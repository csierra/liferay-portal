...
package com.liferay.multi.factor.authentication.checker.timebased.otp.web.internal.configuration;
...
@Meta.OCD(
	id = "com.liferay.multi.factor.authentication.checker.timebased.otp.web.internal.configuration.MFATimebasedOTPConfiguration",
...
public interface MFATimebasedOTPConfiguration {
	...
	@Meta.AD(
		deflt = "mfa-time-based-one-time-password-configuration", name = "name",
		required = false
	)
	public String name();
