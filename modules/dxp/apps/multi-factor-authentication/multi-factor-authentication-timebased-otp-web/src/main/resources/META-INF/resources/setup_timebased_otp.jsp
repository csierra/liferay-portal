...
<div class="sheet-section">
	<h4>
		<liferay-ui:message key="please-setup-your-verification" />
	</h4>

	<aui:input disabled="<%= true %>" label="shared-secret" name="sharedSecret" showRequiredLabel="yes" value="<%= sharedSecret %>" />
