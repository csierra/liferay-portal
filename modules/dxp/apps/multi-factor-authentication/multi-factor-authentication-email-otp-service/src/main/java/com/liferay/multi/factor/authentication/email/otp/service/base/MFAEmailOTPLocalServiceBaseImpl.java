 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.multi.factor.authentication.email.otp.service.impl.MFAEmailOTPLocalServiceImpl}.
 * </p>
 *
 * @author Arthur Chan
 * @see com.liferay.multi.factor.authentication.email.otp.service.impl.MFAEmailOTPLocalServiceImpl
 * @generated
 */
public abstract class MFAEmailOTPLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MFAEmailOTPLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MFAEmailOTPLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.multi.factor.authentication.email.otp.service.MFAEmailOTPLocalServiceUtil</code>.
	 */
	...
	public MFAEmailOTP createMFAEmailOTP(long emailOTPId) {
		return mfaEmailOTPPersistence.create(emailOTPId);
	}
	...
	public MFAEmailOTP deleteMFAEmailOTP(long emailOTPId)
		...
		return mfaEmailOTPPersistence.remove(emailOTPId);
	}
	...
	public MFAEmailOTP fetchMFAEmailOTP(long emailOTPId) {
		return mfaEmailOTPPersistence.fetchByPrimaryKey(emailOTPId);
	}
	...
	public MFAEmailOTP getMFAEmailOTP(long emailOTPId) throws PortalException {
		return mfaEmailOTPPersistence.findByPrimaryKey(emailOTPId);
	}
