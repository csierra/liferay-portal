...
public class Users extends Application {
	...
	public Set<Object> getSingletons() {
		return new HashSet<>(
			Arrays.asList(_companyContextProvider, _usersResource));
	}
	...
	@Reference
	protected void setCompanyContextProvider(
	...
	@Reference
	protected void setUsersResource(UsersResource usersResource) {
