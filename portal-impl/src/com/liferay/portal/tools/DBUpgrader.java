	...
	public static void verify() throws Exception {
		...
		if (release == null) {
			release = ReleaseLocalServiceUtil.addRelease(
				ReleaseConstants.DEFAULT_SERVLET_CONTEXT_NAME, "7.0.0");
		}
		...
		Version buildVersion = Version.getInstance("7.0.0");
		Version releaseVersion = Version.getInstance(release.getBuildNumber());

		if (buildVersion.compareTo(releaseVersion) > 0) {
			newBuildNumber = true;
		}
