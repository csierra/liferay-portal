...
import com.liferay.portal.kernel.internal.security.access.control.AllowedIpsValidator;
import com.liferay.portal.kernel.internal.security.access.control.AllowedIpsValidatorFactory;
	...
	public static boolean isAccessAllowed(
		...
		for (String hostAllowed : hostsAllowed) {
			AllowedIpsValidator allowedIpsValidator =
				AllowedIpsValidatorFactory.create(hostAllowed);

			if (allowedIpsValidator.isAllowedIP(remoteAddr)) {
				return true;
			}
		}
